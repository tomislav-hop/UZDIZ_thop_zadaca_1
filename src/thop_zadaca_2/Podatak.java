...
public class Podatak{
    ...
    public Podatak(int tipZapisa, int sifra, int roditelj, String koordinate, String boja, boolean status) {
    ...
    public String toString() {
        ...
        return ("Tip zapisa: " + tipZapisa + "\tSifra: " + sifra + "\tRoditelj: " + roditelj + "\tBoja: " + boja + "\tStatus: " + status + "\tKoordinate: " + koordinate);
    }
